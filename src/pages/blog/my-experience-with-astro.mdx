...
ogimage: "/assets/my-experience-with-astro.png"
author: "Lance Ross"
...
![My website when I started Astro](/static/old-site-preview.webp)

I was getting used to it while focusing on making my website look beautiful. I started to learn how does Astro work and how do you create your website with it? I tried deleting all the default components and started to make my own (without ready-made components that I just found on the internet). I am getting a lot of positive feedback about my site that it looks beautiful. After a few weeks of learning it, I finally built this beautiful website of mine using Astro and [Tailwind CSS](https://tailwindcss.com) 😍
