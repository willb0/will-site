...
export async function get({ params }: APIContext) {
  ...
  const markup = html` <div style="color: #111827; width: 1200px; height: 768px; display: flex; flex-direction: column;">
    ...
    <div style="background-color: #393E41; width: 100%; height: 20%; display: flex; align-items: center; justify-content: flex-end; padding: 0px 50px; border-top: 2px solid #bfdbfe;">
